			...
			<div class="role_view_section">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Post a Announcement</h4>
                    </div>
                    <div class="panel-body">
	                    <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" action="{{route('admin-announcement.store')}}" method="POST" enctype="multipart/form-data">
	                    	{{ csrf_field() }}
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6">
									<div class="input-group date" id="datetimepicker1">
                                        <input type="text" class="form-control" name="start_date_time" placeholder="Required" />
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6">
									<div class="input-group date" id="datetimepicker3">
                                        <input type="text" class="form-control" name="last_date_time" placeholder="Required" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                        			@if ($errors->has('last_date_time'))
                                        <span class="text-danger">{{ $errors->first('last_date_time') }}</span>
                                    @endif
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6">
									<textarea style="text-transform: initial; text-align: justify;" class="textarea form-control" placeholder="Enter text ..." rows="12" name="description"></textarea>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6">
									<button type="submit" class="btn btn-success btn-trans waves-effect w-md waves-success">POST</button>
								</div>
							</div>
	                    </form>
                    </div>
