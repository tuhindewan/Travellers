...
@extends('backend.layout.app')
    ...
    <div id="content" class="content">
        ...
        <h1 class="page-header"><small>Dashboard > Administration > </small>{{$getReports[0]->report_post->users['fullname']}} Report Page</h1>
        <hr>
        <!-- start row -->
        <div class="row">
            <div class="role_view_section">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title" style="text-transform: capitalize;">{{$getReports[0]->report_post->users['fullname']}}</h4>
                    </div>
                        ...
                        <div class="view_admin_profile_section">
                            <div class="profile-section">
                                ...
                                <div class="profile-left">
                                    <?php $image = $getReports[0]->report_post->post_image[0]['images']; ?>
                                    <!-- begin profile-image -->
                                    <div class="profile-image">
                                        <img src='{{asset("images/post/photo/thum/$image")}}' />
                                        <i class="fa fa-user hide"></i>
                                    </div>
                                    <!-- end profile-image -->
                                    <div class="m-b-10">
                                        <?php $postId =  $getReports[0]->report_post['_id']?>
                                        <input type="hidden" value="{{ $postId }}" id="uId">
                                        <a href='{{URL::to("/user-post-admin/$postId")}}' class="btn btn-warning btn-block btn-sm" target="_blank">View post</a>
                                    </div>
