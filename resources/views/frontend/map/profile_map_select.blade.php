@push('css-style')
	...
	<style>
		#pac-input-search { width: 50%; margin-left: 15px;}
	</style>
@endpush
    ...
    <div id="profile-map" style="position: absolute; width: 100%; height: 650px;"></div>
	...
	function initMap() {
		...
		var map = new google.maps.Map(document.getElementById('profile-map'), {
          	...
          	center: {lat: 33.93911, lng: 67.70995300000004},
    ...
    // more details for that place.
	  ...
	  // Add a marker clusterer to manage the markers.
		...
		var locations = [
			...
			<?php 
				foreach ($getplacesByUser as $placeData) {
					foreach ($getPlace as $place) {
						if ($placeData == $place->_id) {
							?>
							{
