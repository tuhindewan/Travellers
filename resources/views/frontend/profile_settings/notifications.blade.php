					...
					<div class="col-md-9">
						<div class="profileSet-ui-block">
							<div class="profileSet-ui-block-title" style="border-bottom: 1px solid #e6ecf5;">
								<h6 class="title" style="width: 725px;">Notifications</h6>
								<a href="#" class="more"><svg class="olymp-three-dots-icon"><use xlink:href="icons/icons.svg#olymp-three-dots-icon"></use></svg></a>
							</div>

							<ul class="notification-list">
								@foreach($friendnotis as $noti)
								
								@if($noti['type']==1)
									<li class="">
										<div class="author-thumb">
											<?php 
												$image = $noti->senderuser->user_image['image']; 
											?>
											<img src='{{asset("images/users$image")}}' alt="author">
										</div>
										<div class="notification-event">
											You and <a href="#" class="h6 notification-friend">{{ $noti->senderuser['firstname'] }} {{ $noti->senderuser['middlename'] }} {{ $noti->senderuser['lastname'] }} </a> just became friends. Write on <a href="#" class="notification-link">his wall</a>.
