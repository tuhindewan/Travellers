...
<div class="section">
  <div class="overlay-modal overlay-modal-edit<?php echo $_id; ?>" style="margin-left: -435px; display: none;">
    <div class="travel_dialog show_travel_edit<?php echo $_id; ?>" style="min-height: 90px;">
      <div class="fade-box-edit fade-box<?php echo $_id; ?>">
        ...
        <div class="inner_body">
          <div class="inner_body_content">
            <textarea id="post-comment-edit<?php echo $comment['_id'];?>" class="form-control edit-textarea"><?php echo $comment['comment']; ?></textarea>
          </div>
          <div class="inner_buttons">
            <button class="okay_modal_button edit_button_ok<?php echo $_id; ?>" type="submit" tabindex="0">
              Okay
            </button>
