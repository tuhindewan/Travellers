			        ...
			        <div class="collapse navbar-collapse" id="myNavbar">
			          <ul class="nav navbar-nav">
			          	<li>
			          		...
			          		?>
			          		<div class="row">
			          			<div class="col-sm-4 col-xs-4 padding_img_div">
			          				<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
			          					<img src="{{ $profile_image }}" alt="{{ Auth::user()->fullname }}" />
			          				</a>
			          			</div>
			          			<div class="col-sm-8 col-xs-8 res_span_div">
			          				<span class="res_fs_13">{{Auth::user()->fullname}}</span> <br>
			          				<span class="res_fs_11">I am a Engineer</span>
			          			</div>
			          		</div>
			          	</li>
            			<li class=" {{ Request::is('/')?"active":"" }} "><a href="{{URL::to('/')}}"><img style="width: 20px;height: 20px;margin-right: 5px;" src="https://png.icons8.com/color/50/000000/home.png">Home</a></li>
            			<?php $username = Auth::user()->username; ?>
                        <li class='{{ Request::is("$username") ? "active":"" }}'>
                        	<a href='{{URL::to("/$username")}}'><img style="width: 20px;height: 20px;margin-right: 5px;" src="https://png.icons8.com/dusk/50/000000/contract-job.png">Profile</a>
                        </li>
                        <li class=" {{ Request::is('connection')?"active":"" }} "><a href="{{URL::to('/connection')}}"><img style="width: 20px;height: 20px;    margin-right: 5px;" src="https://png.icons8.com/color/50/000000/groups.png">Connection</a></li>
                        <li class="{{ Request::is('map')?'active':'' }}"><a href="{{URL::to('/map')}}"><img style="width: 20px;height: 20px;    margin-right: 5px;" src="https://png.icons8.com/nolan/50/000000/google-maps.png">Map</a></li>
                        <li class="{{ Request::is('stay-with-locals')?'active':'' }}"><a href="{{URL::to('/stay-with-locals')}}"><img style="width: 20px;height: 20px;    margin-right: 5px;" src="https://png.icons8.com/color/50/000000/blockchain-technology.png">Stay with locals</a></li>
                        <li class="li-header">Help & Settings</li>
                        <li><a href="{{URL::to('settings')}}"><img style="width: 20px;height: 20px;    margin-right: 5px;" src="https://png.icons8.com/office/50/000000/gears.png">Settings</a></li>
                        <li><a href="{{URL::to('/users/logout')}}"><img style="width: 20px;height: 20px;    margin-right: 5px;" src="https://png.icons8.com/dusk/50/000000/exit.png">Log Out</a></li>
			          </ul>
			        </div>
			      </div>
			    </nav>
