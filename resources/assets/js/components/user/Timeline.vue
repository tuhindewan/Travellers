					...
					<div class="row timeline-row-newsletter">
						<div class="newsletter-scroll">
                            ...
                            <div class="hidden-md hidden-lg">
                                <router-link :to="{ name: 'experiences' }" @click.native="changeMap('')">
                                    <a class="res_timeline_xp  active"><img class="res_timeline_xp_img " src="public/frontend/img/experiences.png" alt=""> Experiences</a>
                                </router-link>
                            </div>

                            <div class="hidden-md hidden-lg">
                                <router-link :to="{ name: 'plans' }" @click.native="changeMap('plans')">
                                    <a class="res_timeline_plan "><img class="res_timeline_plan_img " src="public/frontend/img/plans.png" alt=""> Plans</a>
                                </router-link>
                            </div>

                            <div class="hidden-md hidden-lg">
                                <router-link :to="{ name: 'suggestions' }" @click.native="changeMap('suggestions')">
                                    <a class="res_timeline_sug "><img class="res_timeline_sug_img " src="public/frontend/img/suggestions.png" alt=""> Suggestions</a>
                                </router-link>
                            </div>

                            <div class="hidden-md hidden-lg">
                                <router-link :to="{ name: 'questions' }" @click.native="changeMap('questions')">
                                    <a class="res_timeline_question "><img class="res_timeline_question_img " src="public/frontend/img/questions.png" alt=""> Questions</a>
                                </router-link>   
                            </div>
