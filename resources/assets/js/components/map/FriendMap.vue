...
import VueRouter from 'vue-router';
  const router = new VueRouter({
        ...
        routes: [
            {
                path: '/travel-project'+'/map',
                name: 'experiences',
                //component: Experiences,
            },
            {
                path: '/travel-project'+'/map/plans',
                name: 'plans',
                //component: Plans,
            },
            
            {
                path: '/travel-project'+'/map/suggestions',
                name: 'suggestions',
                //component: Suggestions,
            },
            {
                path: '/travel-project'+'/map/questions',
                name: 'questions',
                //component: Questions,
            },
        ],
...
export default {
      ...
      methods:{
        getLocation(markers,idx){
          ...
          if(markers.id){
            ...
            var placeName = '';
            if(this.$route.fullPath=='/travel-project/map/suggestions'){
              placeName  = '/suggestions';
            }else if(this.$route.fullPath=='/travel-project/map/plans'){
              placeName  = '/plans';
            }else if(this.$route.fullPath=='/travel-project/map/questions'){
              placeName  = '/questions';
            }else{
              placeName  = '';
            }
        ...
        changeMap(e){
          ...
          if(e=='plans'){
                axios.get(this.url+'/friend-wise-markers'+'/3').then( response=> {
                    
                    this.markers = response.data;
                });
          }else if(e=='suggestions'){
                axios.get(this.url+'/friend-wise-markers'+'/1').then( response=> {
                    
                    this.markers = response.data;
                });

          }else if(e=='questions'){
                axios.get(this.url+'/friend-wise-markers'+'/2').then( response=> {
                ...
                axios.get(this.url+'/friend-wise-markers'+'/4').then( response=> {
    ...
    mounted(){
      ...
      //var place  = ;
      axios.get(this.url+'/friend-wise-markers'+'/'+place).then( response=> {
