<template>
    <div class="input-group message-sender-input">
        ...
        <input :id="userId" type="text" class="form-control" placeholder="Type your message here..." @keyup.enter="sendMessage"  v-model="messageText">
        <span class="input-group-btn">
            <button :id="userId" class="btn btn-success btn-send" type="button" @click="sendMessage">Send</button>
        </span>
    </div>
</template>
    ...
    export default {
        ...
        watch:{
            messageText(){
                ...
                var privateId = authId+this.userId; // unique id for private chat
