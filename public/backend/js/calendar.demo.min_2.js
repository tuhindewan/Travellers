var handleCalendarDemo=function() {
    ...
    $("#calendar").fullCalendar( {
        ...
        , editable:!0, eventLimit:!0, events:[ {
            title: "All Day Event", start: e+"-"+a+"-01", color: "#00acac"
        }
        , {
            title: "Long Event", start: e+"-"+a+"-07", end: e+"-"+a+"-10"
        }
        , {
            id: 999, title: "Repeating Event", start: e+"-"+a+"-09T16:00:00", color: "#00acac"
        }
        , {
        ...
        , {
            title: "Meeting", start: e+"-"+a+"-12T10:30:00", end: e+"-"+a+"-12T12:30:00", color: "#00acac"
        }
        , {
            title: "Lunch", start: e+"-"+a+"-12T12:00:00", color: "#348fe2"
        }
        , {
        ...
        , {
            title: "Click for Google", url: "http://google.com/", start: e+"-"+a+"-28", color: "#ff5b57"
        }
        ]
    }
    )
