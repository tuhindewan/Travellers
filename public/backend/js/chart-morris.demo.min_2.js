...
var handleMorrisBarChart=function() {
    Morris.Bar( {
        ...
        ], xkey:"device", ykeys:["geekbench"], labels:["Geekbench"], barRatio:.4, xLabelAngle:35, hideHover:"auto", resize:true, barColors:[dark]
    }
    )
}
...
var handleMorrisAreaChart=function() {
    Morris.Area( {
        ...
        ], xkey:"period", ykeys:["iphone", "ipad", "itouch"], labels:["iPhone", "iPad", "iPod Touch"], pointSize:2, hideHover:"auto", resize:true, lineColors:[red, orange, dark]
    }
    )
}
...
var handleMorrisDonusChart=function() {
    Morris.Donut( {
        ...
        , resize:true, colors:[dark, orange, red, grey]
    }
    )
}
