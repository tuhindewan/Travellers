...
handleVisitorsLineChart=function() {
    ...
    Morris.Line( {
        ...
        ], xkey:"x", ykeys:["y", "z"], xLabelFormat:function(a) {
            return a=getMonthName(a.getMonth()), a.toString()
        }
        , labels:["Page Views", "Unique Visitors"], lineColors:[a, c], pointFillColors:[b, d], lineWidth:"2px", pointStrokeColors:[e, e], resize:!0, gridTextFamily:"Open Sans", gridTextColor:f, gridTextWeight:"normal", gridTextSize:"11px", gridLineColor:"rgba(0,0,0,0.5)", hideHover:"auto"
    }
    )
}
...
handleVisitorsDonutChart=function() {
    ...
    Morris.Donut( {
        ...
        ], colors:[a, b], labelFamily:"Open Sans", labelColor:"rgba(255,255,255,0.4)", labelTextSize:"12px", backgroundColor:"#242a30"
    }
    )
}
...
handleVisitorsVectorMap=function() {
    0!==$("#visitors-map").length&&$("#visitors-map").vectorMap( {
        map:"world_merc_en", scaleColors:["#e74c3c", "#0071a4"], container:$("#visitors-map"), normalizeFunction:"linear", hoverOpacity:.5, hoverColor:!1, markerStyle: {
            initial: {
...
handleScheduleCalendar=function() {
    ...
    g=$("#schedule-calendar");
    $(g).calendar( {
        months:a, days:b, events:f, popover_options: {
            placement: "top", html: !0
        }
    }
    ),
...
handleDashboardGritterNotification=function() {
    ...
    //     setTimeout(function() {
    //         $.gritter.add( {
    //             title: "Welcome back, Admin!", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempus lacus ut lectus rutrum placerat.", image: "assets/img/user-14.jpg", sticky: !0, time: "", class_name: "my-sticky-class"
    //         }
    //         )
    //     }
    //     , 1e3)
